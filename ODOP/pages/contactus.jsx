            ...
            <div className="row justify-content-center pb-5">
              <div className="card col-md-3 mt-100">
                <div className="card-content">
                  <div className="card-body p-0">
                    ...
                    <div className="card-title mt-4">  Mistry Vatsal<br /> <small>Head of marketing at K mart</small> </div>
              ...
              <div className="card col-md-3 mt-100">
                <div className="card-content">
                  <div className="card-body p-0">
                    <div className="profile"> <img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1574583319/AAA/3.jpg" /> </div>
                    <div className="card-title mt-4"> Patoliya Parth<br /> <small>CEO of Redbull</small> </div>
                    <div className="card-subtitle">
              ...
              <div className="card col-md-3 mt-100">
                <div className="card-content">
                  <div className="card-body p-0">
                    <div className="profile">  <img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1574583319/AAA/3.jpg" /></div>
                    <div className="card-title mt-4"> Patel Pranav<br /> <small>Resident Dj at ibdc</small> </div>
                    <div className="card-subtitle">
              ...
              <div className="card col-md-3 mt-100">
                <div className="card-content">
                  <div className="card-body p-0">
                    ...
                    <div className="card-title mt-4"> Mistry Vatsal<br /> <small>Resident Dj at ibdc</small> </div>
                    <div className="card-subtitle">
                      <p> <small className="text-muted"> I always wanted cool videos of my concerts never knew whom to talk to but they are amazing! </small> </p>
                    </div>
                  </div>
              ...
              <div className="card col-md-3 mt-100">
                <div className="card-content">
                  <div className="card-body p-0">
                    <div className="profile"> <img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1574583246/AAA/2.jpg" /> </div>
                    <div className="card-title mt-4"> Patoliya Parth<br /> <small>Resident Dj at ibdc</small> </div>
                    <div className="card-subtitle">
                      <p> <small className="text-muted"> I always wanted cool videos of my concerts never knew whom to talk to but they are amazing! </small> </p>
                    </div>
                  </div>
